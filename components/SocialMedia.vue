...
export default {
	...
	methods: {
		getSocialMediaLinks: function() {
			this.facebook = this.$store.state.siteData.data[0].facebook
			this.linkedin = this.$store.state.siteData.data[0].linkedin
			this.twitter = this.$store.state.siteData.data[0].twitter
			this.instagram = this.$store.state.siteData.data[0].instagram
			this.youtube = this.$store.state.siteData.data[0].youtube
			this.vimeo = this.$store.state.siteData.data[0].vimeo
		}
	}
}
</script>
